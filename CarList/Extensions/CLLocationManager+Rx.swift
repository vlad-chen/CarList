...
extension Reactive where Base: CLLocationManager {
    ...
    */
    ...
    Reactive wrapper for `delegate` message.
    */
    public var didFailWithError: Observable<Swift.Error> {
    ...
    Reactive wrapper for `delegate` message.
    */
    public var didFinishDeferredUpdatesWithError: Observable<Swift.Error?> {
        return delegate.methodInvoked(#selector(CLLocationManagerDelegate.locationManager(_:didFinishDeferredUpdatesWithError:)))
            .map { a in
                return try castOptionalOrThrow(Swift.Error.self, a[1])
            }
    }
    #endif
    ...
    */
    ...
    Reactive wrapper for `delegate` message.
    */
    public var monitoringDidFailForRegionWithError: Observable<(region: CLRegion?, error: Swift.Error)> {
        return delegate.methodInvoked(#selector(CLLocationManagerDelegate.locationManager(_:monitoringDidFailFor:withError:)))
            .map { a in
                ...
                let error = try castOrThrow(Swift.Error.self, a[2])
    ...
    */
    ...
    Reactive wrapper for `delegate` message.
    */
    public var rangingBeaconsDidFailForRegionWithError: Observable<(region: CLBeaconRegion, error: Swift.Error)> {
